...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccountData.user_profile'
        db.add_column('account_data', 'user_profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cabinet.UserProfile'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AccountData.profile'
        db.add_column('account_data', 'profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cabinet.UserProfile'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'AccountData.user_profile'
        db.delete_column('account_data', 'user_profile_id')
    ...
    models = {
        ...
        u'cabinet.accountdata': {
            'Meta': {'object_name': 'AccountData', 'db_table': "'account_data'"},
            ...
            'user_profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cabinet.UserProfile']", 'null': 'True', 'blank': 'True'})
        },
