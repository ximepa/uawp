...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.premium_start'
        db.alter_column(u'cabinet_userprofile', 'premium_start', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'UserProfile.premium_end'
        db.alter_column(u'cabinet_userprofile', 'premium_end', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserProfile.premium_start'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.premium_start' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'UserProfile.premium_start'
        db.alter_column(u'cabinet_userprofile', 'premium_start', self.gf('django.db.models.fields.DateTimeField')())

        # User chose to not deal with backwards NULL issues for 'UserProfile.premium_end'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.premium_end' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'UserProfile.premium_end'
        db.alter_column(u'cabinet_userprofile', 'premium_end', self.gf('django.db.models.fields.DateTimeField')())
