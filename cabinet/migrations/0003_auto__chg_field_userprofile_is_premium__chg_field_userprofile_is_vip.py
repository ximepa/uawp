...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.is_premium'
        db.alter_column(u'cabinet_userprofile', 'is_premium', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'UserProfile.is_vip'
        db.alter_column(u'cabinet_userprofile', 'is_vip', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserProfile.is_premium'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.is_premium' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'UserProfile.is_premium'
        db.alter_column(u'cabinet_userprofile', 'is_premium', self.gf('django.db.models.fields.BooleanField')())

        # User chose to not deal with backwards NULL issues for 'UserProfile.is_vip'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.is_vip' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'UserProfile.is_vip'
        db.alter_column(u'cabinet_userprofile', 'is_vip', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'cabinet.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_premium': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'is_vip': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'premium_end': ('django.db.models.fields.DateTimeField', [], {}),
            'premium_start': ('django.db.models.fields.DateTimeField', [], {}),
