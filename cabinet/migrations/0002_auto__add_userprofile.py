...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cabinet_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('coints', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('is_premium', self.gf('django.db.models.fields.BooleanField')()),
            ('is_vip', self.gf('django.db.models.fields.BooleanField')()),
            ('premium_start', self.gf('django.db.models.fields.DateTimeField')()),
            ('premium_end', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'cabinet', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table(u'cabinet_userprofile')
    ...
    models = {
        ...
        u'cabinet.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_premium': ('django.db.models.fields.BooleanField', [], {}),
            'is_vip': ('django.db.models.fields.BooleanField', [], {}),
