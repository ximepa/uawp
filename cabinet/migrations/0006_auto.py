...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field game_acc on 'UserProfile'
        m2m_table_name = db.shorten_name(u'cabinet_userprofile_game_acc')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'cabinet.userprofile'], null=False)),
            ('accountdata', models.ForeignKey(orm[u'cabinet.accountdata'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprofile_id', 'accountdata_id'])


    def backwards(self, orm):
        # Removing M2M table for field game_acc on 'UserProfile'
        db.delete_table(db.shorten_name(u'cabinet_userprofile_game_acc'))
    ...
    models = {
        ...
        u'cabinet.userprofile': {
            ...
            'game_acc': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'game_accounts'", 'symmetrical': 'False', 'to': u"orm['cabinet.AccountData']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
