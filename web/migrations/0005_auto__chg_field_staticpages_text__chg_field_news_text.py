...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StaticPages.text'
        db.alter_column(u'web_staticpages', 'text', self.gf('tinymce.models.HTMLField')())

        # Changing field 'News.text'
        db.alter_column(u'web_news', 'text', self.gf('tinymce.models.HTMLField')())

    def backwards(self, orm):

        # Changing field 'StaticPages.text'
        db.alter_column(u'web_staticpages', 'text', self.gf('django.db.models.fields.TextField')())

        # Changing field 'News.text'
        db.alter_column(u'web_news', 'text', self.gf('django.db.models.fields.TextField')())
