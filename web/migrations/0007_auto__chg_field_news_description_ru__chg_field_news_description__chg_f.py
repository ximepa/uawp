...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'News.description_ru'
        db.alter_column(u'web_news', 'description_ru', self.gf('tinymce.models.HTMLField')(null=True))

        # Changing field 'News.description'
        db.alter_column(u'web_news', 'description', self.gf('tinymce.models.HTMLField')())

        # Changing field 'News.description_en'
        db.alter_column(u'web_news', 'description_en', self.gf('tinymce.models.HTMLField')(null=True))

    def backwards(self, orm):

        # Changing field 'News.description_ru'
        db.alter_column(u'web_news', 'description_ru', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'News.description'
        db.alter_column(u'web_news', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'News.description_en'
        db.alter_column(u'web_news', 'description_en', self.gf('django.db.models.fields.TextField')(null=True))
